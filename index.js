...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: The varible internal was defined in the block of scope of the myFunction.The nestedFunction  an log internal because its in the block of myFunction.
...
function CuboidMaker(single) {
  this.length = single.length,
